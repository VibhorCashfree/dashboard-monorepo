...
// Services
import { getBatchEntries, getBatchEntriesCount } from 'services/pan-lite';
...
const BatchPANLiteDetails = () => {
  ...
  const handleRowClick = row => {
    ...
    navigate(`/pan-lite/details/${row.cfFileId}/${row.id}`, {
      state: { row },
    });
  };
...
export default BatchPANLiteDetails;
