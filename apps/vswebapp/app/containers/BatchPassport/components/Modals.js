...
// Services
import { createBatch, updateBatch, getErrorLog } from 'services/passport';
          ...
          <Table basic="very" compact className="mt-3 px-5">
            <Table.Body>
              <Table.Row>
                ...
                <Table.Cell>{_get(modalData, 'file_number', '–') || '–'}</Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell width={6}>
                  <Text color="bodyLight">Full Name</Text>
                </Table.Cell>
                <Table.Cell>{_get(modalData, 'name', '–') || '–'}</Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell width={6}>
                  <Text color="bodyLight">Date of Birth</Text>
                </Table.Cell>
                <Table.Cell>{_get(modalData, 'dob', '–')}</Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell width={6}>
                ...
                <Table.Cell>
                  {_get(modalData, 'application_type', '–') || '–'}
                </Table.Cell>
              </Table.Row>
              <Table.Row>
                <Table.Cell width={6}>
                ...
                <Table.Cell>
                  {_get(modalData, 'application_received_date', '–') || '–'}
                </Table.Cell>
              </Table.Row>
            </Table.Body>
          </Table>
