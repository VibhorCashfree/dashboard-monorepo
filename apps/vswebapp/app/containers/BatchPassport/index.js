...
const BatchPassport = () => {
  ...
  const handleRowClick = row => {
    ...
    navigate(`/passport/batch/${row.id}/details`, {
  ...
  return (
    <>
      <Text className="my-2" color="bodyLight">
        Passport and the verification statuses are shown here.{' '}
        <a href={PRODUCTS.PASSPORT.docs} target="_blank" data-event-name="Link">
          Know more
        </a>
      </Text>
      <FilterRowContainer>
