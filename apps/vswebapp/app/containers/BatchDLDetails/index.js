...
// Services
import { getBatchEntries, getBatchEntriesCount } from 'services/dl';
...
const BatchDLDetails = () => {
  ...
  const handleRowClick = row => {
    ...
    navigate(`/driving-license/details/${row.cfFileId}/${row.id}`, {
      state: { row },
    });
  };
