...
const BatchDL = () => {
  ...
  const handleRowClick = row => {
    ...
    navigate(`/driving-license/batch/${row.id}/details`, {
  ...
  return (
    <>
      <Text className="my-2" color="bodyLight">
        DL and the verification statuses are shown here.{' '}
        <a
          href={PRODUCTS.DRIVING_LICENSE.docs}
          target="_blank"
