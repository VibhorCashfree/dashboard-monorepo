...
// Services
import { getBatches, getBatchesCount, downloadBatchReport } from 'services/PAN';
...
const BatchPan = () => {
  ...
  const handleRowClick = row => {
    ...
    navigate(`/pan/batch/${row.id}/details`, { state: { batchRowDetails } });
  };
  ...
  return (
    <>
      <Text className="my-2" color="bodyLight">
        ...
        <a href={KNOW_MORE.PAN.ALL} data-event-name="Link" target="_blank">
          Know more
        </a>
      </Text>
      <FilterRowContainer>
