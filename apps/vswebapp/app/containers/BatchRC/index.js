...
// Helpers
import { rowPopup, formattedDate } from 'helpers/common';
...
const BatchRC = () => {
  ...
  const handleRowClick = row => {
    ...
    navigate(`/RC/batch/${row.id}/details`, { state: { batchRowDetails } });
  };
  ...
  return (
    <>
      <Text className="my-2" color="bodyLight">
        Vehicle RC and the verification statuses are shown here.{' '}
        <a
          href={PRODUCTS.VEHICLE_RC.docs}
          target="_blank"
