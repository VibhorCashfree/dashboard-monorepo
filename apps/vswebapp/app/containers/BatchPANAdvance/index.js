...
const BatchPANAdvance = () => {
  ...
  const handleRowClick = row => {
    ...
    navigate(`/pan-360/batch/${row.id}/details`, {
  ...
  return (
    <>
      <Text className="my-2" color="bodyLight">
        PAN 360 and the verification statuses are shown here.{' '}
        <a
          href={PRODUCTS.PAN_ADVANCE.docs}
          target="_blank"
...
export default BatchPANAdvance;
