...
// Services
import { getBatchEntries, getBatchEntriesCount } from 'services/passport';
...
const BatchPassportDetails = () => {
  ...
  const handleRowClick = row => {
    ...
    navigate(`/passport/details/${row.cfFileId}/${row.id}`, {
      state: { row },
    });
  };
...
export default BatchPassportDetails;
