...
import UPImobilePitchPage from 'containers/UPImobilePitchPage';
...
const BatchUPI = () => {
  ...
  const handleRowClick = row => {
    ...
    navigate(`/upi-mobile/batch/${row.id}/details`, {
