...
// Services
import { getBatchEntries, getBatchEntriesCount } from 'services/UPI';
...
const BatchUpiDetails = () => {
  ...
  const toBeApproved = _get(location.state, 'toBeApproved', true);
...
export default BatchUpiDetails;
