...
// Services
import { createBatch, updateBatch, getErrorLog } from 'services/cashgrams';
...
const Modals: React.FC<ModalsProps> = ({
  ...
  const handleFileUpload = (payload: { fileType: string; file: File }) => {
    ...
    case MODAL_TYPE.UPLOAD:
      return (
        <UploadFileModal
          ...
          modalTitle="Upload Batch Cashgram File"
    ...
    case MODAL_TYPE.SUCCESS:
      return (
        <AlertModal
          ...
          eventNameOnConfirm="Primary_Batch_Cashgrams_File_Upload_Success"
          eventNameOnClose="Secondary_Batch_Cashgrams_File_Upload_Success"
          onClose={() => setModalType(MODAL_TYPE.EMPTY)}
        />
      );
    ...
    case MODAL_TYPE.CANCEL:
      return (
        <AlertModal
          ...
          eventNameOnConfirm="Primary_Batch_Cashgrams_File_Upload_Cancelled"
          eventNameOnClose="Secondary_Batch_Cashgrams_File_Upload_Cancelled"
          onClose={() => setModalType(MODAL_TYPE.EMPTY)}
        />
      );
    ...
    case MODAL_TYPE.FAILED:
      return (
        <AlertModal
          ...
          eventNameOnConfirm="Primary_Batch_Cashgrams_File_Upload_Failed"
          eventNameOnClose="Secondary_Batch_Cashgrams_File_Upload_Failed"
          onClose={() => setModalType(MODAL_TYPE.EMPTY)}
        >
    ...
    case MODAL_TYPE.FAILED_WITH_VALID:
      return (
        <AlertModal
          ...
          eventNameOnConfirm="Primary_Batch_Cashgrams_File_Upload_Errors_Found"
          eventNameOnClose="Secondary_Batch_Cashgrams_File_Upload_Errors_Found"
