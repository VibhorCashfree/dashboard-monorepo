...
beforeEach(() => {
  ...
  jest.spyOn(DevelopersService, 'getWebhookVersions').mockImplementation(() =>
    Promise.resolve({
      entries: [
        {
  ...
  test('checks Modals render', async () => {
    ...
    render(
      <Modals
        ...
        versions={
          ({ '11-2-2024': { version: 'v2', releaseDate: '11-2-2024' } },
          { '4-9-2020': { version: 'v1', releaseDate: '4-9-2020' } })
        }
      />,
