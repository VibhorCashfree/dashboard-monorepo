...
const Modals: React.FC<ModalsProps> = ({
  ...
  const goToApproveBatch = (): void => {
    window.location.href = `${process.env.PUBLIC_PATH}transfers/approve-batch`;
  };
      ...
      return (
        ...
        >
          ...
          <ApprovalsModalInfo
            ...
            count={hasBatchPreference ? batchRowDetails.countTransfers : count}
      ...
      return (
        ...
        >
          <Text as="p" variant="p14" color="bodyLight">
            ...
            <a
              href={`${process.env.PUBLIC_PATH}transfers/batch`}
              className="link"
            >
              batch files section
            </a>
