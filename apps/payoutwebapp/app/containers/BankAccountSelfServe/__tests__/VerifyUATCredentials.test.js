...
describe('BankAccountSelfServe', () => {
  test('<VerifyUATCredentials /> renders correctly', () => {
    const wizardData = {
    ...
    expect(screen.getByText('Verify UAT Credentials')).toBeInTheDocument();

    expect(screen.getByText('1. Enter UAT Credentials')).toBeInTheDocument();
  ...
  test('<VerifyUATCredentials /> handleChange()', async () => {
    const wizardData = {
      bankName: 'RBL_CONNECTED',
      fundSourceId: 14576,
      gateway: {
  ...
  test('<VerifyUATCredentials /> formObj and errorObj prop', () => {
    const wizardData = {
      bankName: 'RBL_CONNECTED',
      fundSourceId: 14576,
      gateway: {
  ...
  test('<VerifyUATCredentials /> actionType prop', async () => {
    const wizardData = {
      bankName: 'RBL_CONNECTED',
      fundSourceId: 14576,
      gateway: {
  ...
  test('<VerifyUATCredentials /> verify buttons', async () => {
    const wizardData = {
      bankName: 'RBL_CONNECTED',
      fundSourceId: 14576,
      gateway: {
