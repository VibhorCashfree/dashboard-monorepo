...
// Images
import BannerBackground from 'images/payoutprotect-bannerbg.svg';
...
export const StyledTooltipInfo = styled.div<{ children: React.ReactNode }>`
  display: flex;
  margin-bottom: 8px;
...
export const StyledBannerBackground = styled(Paper)`
